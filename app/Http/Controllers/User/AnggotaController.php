...
class AnggotaController extends Controller
{
        public function dashboard()
	{
		...
		return view('user.dashboard', compact('jumlah_poin', 'other_payments', 'main_payments', 'monthly_payments', 'wallets'));
	}
...
public function keuanganuser(Request $request)
	{
		...
		return view('user.keuangan', compact('other_payments', 'main_payments', 'monthly_payments', 'wallets'));
	}
