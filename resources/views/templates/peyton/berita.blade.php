...
margin-left: 10px;"><img src="dist/img/logopolindra.png" alt="Logo Polindra">KOPKAR POLINDRA</h4></div>
  ...
  <div class="section is-hero hero-hosting overflow-hidden position-relative hei-min zindex99">
    <div class="container">
      <div  class="col block-centered text-align-center lg-7 md-12">
        <h1>Blog Berita</h1>
        <div class="padding-left padding-right margin-bottom">Kabar berita terupdate hari ini</div>
      </div>
    </div>
  </div>
  <div class="section">
    ...
    @foreach ($berita as $key => $row)
      ...
      <div class="col lg-6 md-12">
        ...
        <div class="c-gridpost__card style4"><a  class="c-gridpost__image-bg w-inline-block"><img src="{{ asset('uploads/' . $row->gambar) }}"</a>
