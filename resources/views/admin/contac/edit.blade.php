    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <h3 class="card-title">Edit Produk {{$contac->judul}}</h3>
				...
				<div class="card-body">
                <form method="post" action="{{ route('admin.contac.update', $contac->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="editor1" class="form-control">{{ $contac->keterangan }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="gambar">Gambar Saat Ini</label><br>
                        <img src=" {{ asset('uploads/' . $contac->gambar) }} " width="300">
                        <br>
