                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @php
                                $tb_poin=DB::table('tb_poin_transaksi')->select('id_user')->groupBy('id_user')->get();
                                @endphp
        ...
        $('#user-table').on('click', '.btn-edit', function() {
            ...
            $.ajax({
                ...
                error: function(res, exception) {
                    ...
                    swal.fire({
                        text: "Terjadi Kesalahan, Mohon Cek Terlebih Dahulu!",
                        icon: "error"
                    });
                }
            });
            ...
            $.ajax({
                ...
                error: function(res, exception) {
                    ...
                    if (res.responseJSON.code) {
                        ...
                        swal.fire({
                            text: "Mohon Masukkan Data Anda Secara Lengkap!",
                            icon: "error"
                        });
                    }
                }
