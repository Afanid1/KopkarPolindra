        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Sejarah Event</h3>
                ...
                <form method="post" action="{{ route('admin.sejarah.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                            <label for="judul">Nama Sejarah</label>
                            <input type="text" name="judul" class="form-control" id="text" placeholder="Enter Nama">
                        </div>

                    <div class="form-group">
                        <label for="keterangan">Sejarah Kopkar</label>
