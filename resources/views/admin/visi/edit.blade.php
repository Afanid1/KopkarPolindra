    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <h3 class="card-title">Edit Produk {{$visi->judul}}</h3>
                ...
                <form method="post" action="{{ route('admin.visi.update', $visi->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="editor1" class="form-control">{{ $visi->keterangan }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="keterangan2">Misi</label>
                        <textarea name="keterangan2" id="editor1" class="form-control">{{ $visi->keterangan2 }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="gambar">Gambar Saat Ini</label><br>
                        <img src=" {{ asset('uploads/' . $visi->gambar) }} " width="300">
                        <br>
...
<!--                         
                    <div class="row">
                        ...
                        <a href="{{ route('admin.visi.index') }}" class="btn btn-warning btn-sd ml-auto">Kembali</a>
