    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <h3 class="card-title">Edit Produk {{$download->judul}}</h3>
                ...
                <form method="post" action="{{ route('admin.download.update', $download->id) }}" enctype="multipart/form-data">
                    ...
                    @method('PUT')
                        <div class="form-group">
                            ...
                            value="{{ $download->judul }}">
                        </div>
                    <div class="form-group">
                        <label for="keterangan">Keterangan</label>
                        <textarea name="keterangan" id="editor1" class="form-control">{{ $download->keterangan }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="gambar">Gambar Saat Ini</label><br>
                        <img src=" {{ asset('uploads/' . $download->gambar) }} " width="300">
                        <br>
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('admin.download.index') }}" class="btn btn-warning btn-sd ml-auto">Kembali</a>
