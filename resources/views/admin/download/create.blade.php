        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Download Event</h3>
                ...
                <form method="post" action="{{ route('admin.download.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                            <label for="judul">Nama Download</label>
                            <input type="text" name="judul" class="form-control" id="text" placeholder="Enter Nama Jenis Event">
                        </div>
