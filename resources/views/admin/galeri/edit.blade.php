    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <h3 class="card-title">Edit Produk {{$galeri->judul}}</h3>
                ...
                <form method="post" action="{{ route('admin.galeri.update', $galeri->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="editor1" class="form-control">{{ $galeri->keterangan }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="gambar">Gambar Saat Ini</label><br>
                        <img src=" {{ asset('uploads/' . $galeri->gambar) }} " width="300">
                        <br>
...
<!--                         
                    <div class="row">
                        ...
                        <a href="{{ route('admin.galeri.index') }}" class="btn btn-warning btn-sd ml-auto">Kembali</a>
